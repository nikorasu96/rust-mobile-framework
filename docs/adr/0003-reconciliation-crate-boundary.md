...
- Status: Accepted; initial mount, stable properties, single keyed moves and insertions implemented; broader structural updates pending
- Date: 2026-09-20
...
nodes, plus one keyed move or insertion per sibling list. Other structural changes are rejected
