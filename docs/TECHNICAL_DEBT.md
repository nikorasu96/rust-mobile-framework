...
| TD-005 | High | Bootstrap mount API still accepts caller-assigned `NodeId`; the new candidate API does not | Make reconciliation and runtime consume `ValidatedTree`, then remove the bootstrap tree before Android work |
