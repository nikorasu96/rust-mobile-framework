...
| TD-006 | Medium | Production handles one keyed move and one keyed insertion linearly; general wide reorders still need order maintenance | Select and benchmark a non-quadratic multi-move strategy before general reorder support |
