...
This protects the intended matching shape; it is not a production Rust benchmark and
does not make a latency claim. Mutation ordering still needs a compiled workload benchmark.
