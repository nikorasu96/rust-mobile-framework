...
| Structural validation | Experimental | duplicate ID/text-child tests | No property schema |
...
| Surface lifecycle | Rust implementation | `rmf-runtime::surface`, ADR-0005, Rust unit tests, six fixtures, 800 generated actions and 1,008 exhaustive transitions | No Android adapter, concurrent executor stress or unbounded proof |
